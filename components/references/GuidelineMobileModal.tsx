...
interface GuidelineMobileModalProps {
  open: boolean;
  onClose: () => void;
  citation: Citation;
}
...
export const GuidelineMobileModal: React.FC<GuidelineMobileModalProps> = ({ open, onClose, citation }) => {
  const effectiveLink = citation.link || citation.url;
